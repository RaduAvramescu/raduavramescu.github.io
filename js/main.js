...
function projectFunction(projectArr) {
  ...
  for (i = 0; i < projectArr.length; i++) {
    ...
    <a target="_blank" class="d-flex align-items-center justify-content-center btn btn-outline-dark font-weight-bold card-btn" href="${projectArr[i].projectDemoURL}">DEMO
    </a> 
    <a target="_blank" class="d-flex align-items-center justify-content-center btn btn-outline-dark font-weight-bold card-btn" href="${projectArr[i].projectCodeURL}">CODE
