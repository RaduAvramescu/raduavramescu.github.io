...
function projectFunction(projectArr) {
  ...
  for (i = 0; i < projectArr.length; i++) {
    ...
    <a target="_blank" class="d-flex align-items-center btn btn-outline-dark font-weight-bold card-btn" href="${projectArr[i].projectDemoURL}">DEMO
    <svg viewBox="0 0 64 64" height="16" class="ml-2">
    ...
    <a target="_blank" class="d-flex align-items-center btn btn-outline-dark font-weight-bold card-btn" href="${projectArr[i].projectCodeURL}">CODE
    <svg viewBox="0 0 128 128" height="16" class="ml-2">
